...
public class Solution implements Serializable, AutoCloseable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        try (ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream("d:\\1.txt"));
            ...
            Solution load = new Solution("test2");
            load.readObject(inputStream);
            load.writeObject("test3");
        }
    }
}
